...
int main(){
    /* This program implements sparse binary polynomial hashing (mutant huge constants), a hashing algorithm
     * converting a list of phrases to a list of groups of 32 bits integer hashes, with hashes in each group
     * determined by the corresponding phrase and some of its previous phrases.
